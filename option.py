...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--num_val_images', type=int, default=16,
                            metavar='N', help='val index')
        ...
        parser.add_argument('--no_val', action='store_true', default=False, help='No need for validation')
        # optimizer params
